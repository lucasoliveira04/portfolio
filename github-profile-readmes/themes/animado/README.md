<p align="center"><a href="../../GALLERY.md">🎛️ Explorar todos os universos</a> · <a href="https://www.lucasoliveira04.com/">🌐 Portfólio</a> · <a href="https://www.linkedin.com/in/lucas-oliveira-campos/">🤝 LinkedIn</a></p>
...
![Ciclo de aprendizado animado: ideia, construir, investigar e aprender.](../../assets/animado/flow.svg)

### 🐍 Cada contribuição deixa um rastro

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="../../assets/animado/snake-dark.svg">
  <img alt="Cobra animada percorrendo o gráfico real de contribuições públicas de lucasoliveira04, gerada pelo GitHub Actions." src="../../assets/animado/snake.svg" width="100%">
</picture>

<sub>Gerada com o gráfico de contribuições do GitHub pelo [Platane/snk](https://github.com/Platane/snk). O workflow reconstrói a cobra e os dados diariamente.</sub>
...
<details>
<summary><b>🧰 Expandir minha caixa de ferramentas</b></summary>

**Backend:** Java, Spring Boot, Spring Security e SQL.<br>
**Comunicação:** Kafka, RabbitMQ e AWS S3.<br>
**Ambiente e observação:** Docker, OpenTelemetry, Grafana e Prometheus.<br>
**Fundamentos em estudo:** C, algoritmos e estruturas de dados.

</details>

<details>
<summary><b>🧪 Abrir o laboratório de ideias</b></summary>
...
<!-- LIVE:START -->
![57 repositórios públicos próprios, 5 estrelas, 10 linguagens predominantes. Consulta em 11/09/2026.](../../assets/animado/stats.svg)
...
<p align="center"><a href="https://www.lucasoliveira04.com/">Portfólio ↗</a> &nbsp;·&nbsp; <a href="https://www.linkedin.com/in/lucas-oliveira-campos/">LinkedIn ↗</a> &nbsp;·&nbsp; <a href="https://github.com/lucasoliveira04?tab=repositories">Explorar repositórios ↗</a></p>

![Commit. Aprenda. Repita.](../../assets/animado/footer.svg)
