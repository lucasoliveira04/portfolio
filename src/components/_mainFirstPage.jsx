                ...
                <div className="w-full md:w-[600px] bg-[#111316] p-8 rounded-lg cursor-default">
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div className={`transition-transform duration-500 ${fade ? "scale-90 opacity-50" : "scale-100 opacity-100"}`}>
                            ...
                            <p className="text-md md:text-lg text-gray-400">{currentText.role}</p>
                            <p className="text-gray-500">{currentText.pronouns}, {currentText.age}</p>
                        </div>
                    </div>

                    <p className={`mt-4 text-gray-300 leading-relaxed text-sm md:text-base transition-opacity duration-500 ${fade ? "opacity-50" : "opacity-100"}`}>
