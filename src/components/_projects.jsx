...
import articlePdf from "../../public/pdf/Artigo_Cientifico__O_impacto_da_pandemia_na_economia_da_Airbnb.pdf";
...
import article from "../../public/img/projects/artico.jpg";
  ...
  const projects = [
    {
      ...
      media: [
        {
          type: "video",
          src: "https://www.youtube.com/embed/IhRlrBPqkrU?wjPNe9Pp61O9AV",
        },
        { type: "image", src: github_dektop_viewer },
        { type: "image", src: github_dektop_viewer_1 },
      ],
    ...
    },
    {
      ...
      media: [
        {
          type: "video",
          src: "https://www.youtube.com/embed/t2eYsNFGEQE?start=2",
        },
      ],
    ...
    },
    {
      ...
      media: [
        {
          type: "video",
          src: "https://www.youtube.com/embed/fDyu3GRaqsY?si=nnYgyDPGdCm1uYZR",
        },
      ],
    ...
    {
      id: 5,
      title: text.projects[4].title,
      description: text.projects[4].description,
      media: [{ type: "image", src: article }],
      siteUrl: articlePdf,
      isInteractive: false,
      technologies: [
      ...
      visitSite: false,
      download: true,
      textVisitSite: text.projects[4].visit,
    },
  ];
  ...
  return (
    <div className="h-auto bg-[#23272b] p-10">
      <div className="mb-6 flex items-center">
        <FaCog
          className="mr-2 text-white transition-transform duration-500 ease-in-out hover:rotate-[360deg]"
          size={24}
        />
      ...
      <div
        className="grid grid-cols-1 justify-center items-center justify-items-center gap-6 
            sm:grid-cols-1 
            md:grid-cols-1 
            lg:grid-cols-2 
            xl:grid-cols-3
